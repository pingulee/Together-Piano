...
export default function FeedbackPage() {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full max-h-screen overflow-auto'>
      <table className='w-2/3 min-w-4/5 max-w-4/5 bg-white'>
        <thead>
        ...
        <tbody>
          {feedbackData.map((data) => (
            <tr key={data.id}>
              <td className='px-6 py-3 min-w-xs max-w-xs border-b border-gray-200 text-black overflow-hidden truncate'>
                <span>{data.id}</span>
              </td>
              <td className='px-6 py-3 min-w-xs max-w-sm border-b border-gray-200 text-black overflow-hidden truncate'>
                {data.title}
              </td>
              <td className='px-6 py-3 min-w-xs max-w-xs border-b border-gray-200 text-black overflow-hidden truncate'>
                {data.nickname}
              </td>
              <td className='px-6 py-3 min-w-xs max-w-xs border-b border-gray-200 text-black overflow-hidden truncate'></td>
              <td className='px-6 py-3 min-w-xs max-w-xs border-b border-gray-200 text-black overflow-hidden truncate'>
                {data.date}
              </td>
            </tr>
